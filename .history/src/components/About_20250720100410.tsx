              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    ...
                    Focused on Data Science Core Skills like statistical analysis, Data Analytics, Python Programming, Postremachine learning algorithms, and practical data applications.
                  </p>
                </div>
              </div>
