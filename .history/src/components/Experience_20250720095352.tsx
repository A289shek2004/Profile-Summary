  ...
  const experiences = [
    {
      ...
      duration: '1–2 Months (Remote)',
      location: 'Remote',
      description: 'Developed AI-powered applications using code agents, assisted in designing websites, and collaborated on real-world client projects. Gained hands-on experience with modern web technologies and AI integration.',
      technologies: ['Python', 'AI/ML', 'Web Development', 'Code Agents'],
