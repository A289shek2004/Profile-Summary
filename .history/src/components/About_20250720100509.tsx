              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    ...
                    Focused on Data Science Core Skills like statistical analysis, Data Analytics, Python Programming, PostgressSQL Database, Bi Tools, Machine learning algorithms, and Artificial .
                  </p>
                </div>
              </div>
